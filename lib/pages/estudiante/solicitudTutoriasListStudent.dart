...
class SolicitudTutoriasListStudent extends StatefulWidget {
  const SolicitudTutoriasListStudent({super.key});

  @override
  State<SolicitudTutoriasListStudent> createState() =>
      _SolicitudTutoriasListStudentState();
}

class _SolicitudTutoriasListStudentState
    extends State<SolicitudTutoriasListStudent> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<tutoriaResponse>>(
        future: estudianteService.getAllTutoringRequestsByStudent(estudiante),
